        ...
        """
            {
              ...
              "system_participating_services": [
                ...
                },
                {
                  ...
                  "service": "tiltakspenger-vedtak-rivers",
                  "instance": "tiltakspenger-vedtak-rivers-66c79785c8-mjcrr",
                  "image": "ghcr.io/navikt/tiltakspenger-vedtak-rivers:5cd90ca221c658a4e5465829cb76ed7eba248908"
                }
              ]
            }
        """.trimIndent()
        ...
        """
            {
              ...
              "system_participating_services": [
                ...
                },
                {
                  ...
                  "service": "tiltakspenger-vedtak-rivers",
                  "instance": "tiltakspenger-vedtak-rivers-769b84ff87-6m5ts",
                  "image": "ghcr.io/navikt/tiltakspenger-vedtak-rivers:263907dd2bdfdd4d9912fec6a721a7558a6111d7"
                }
              ]
            }
        """.trimIndent()
