...
import no.nav.tiltakspenger.vedtak.domene.Rolle
import java.util.*

private const val applicationName = "tiltakspenger-vedtak-rivers"
...
object Configuration {
    ...
    val rapidsAndRivers = mapOf(
        ...
        "KAFKA_CONSUMER_GROUP_ID" to "tiltakspenger-vedtak-rivers-v1",
    )
